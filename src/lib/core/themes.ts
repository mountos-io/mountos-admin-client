...
export interface SkinColors {
  ...
  // Two more elevation steps above cardBg, below border. Literal swatches
  // from the theme's own published surface ramp where one exists (Gruvbox
  // bg3/bg4, Catppuccin surfaceN, Nord's 4th Polar Night tone, Tokyo Night's
  // sidebar/highlight backgrounds); themes whose real spec has no further
...
export const themePresets: ThemePreset[] = [
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.901 0.012 91.5)",
    },
  },
  {
    name: "mountOS Dark",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.314 0 89.9)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.758 0.020 273.2)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.477 0.034 278.6)",
    },
  },
  {
    name: "Dracula",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.403 0.032 277.8)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.8590 0.0206 285.96)",
    },
  },
  {
    name: "Gruvbox Dark",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.550 0.023 62.6)",
    },
  },
  {
    name: "Gruvbox Light",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.690 0.035 76.3)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.354 0.054 293.9)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.855 0.031 339.3)",
    },
  },
  {
    name: "Nord",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.452 0.035 264.1)",
    },
  },
  {
    name: "Solarized Dark",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.372 0.063 217.5)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.876 0.029 91.7)",
    },
  },
  {
    name: "Tokyo Night",
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.306 0.037 273.2)",
    },
  },
  {
    ...
    colors: {
      ...
      surfaceOverlay: "oklch(0.774 0.006 274.9)",
    },
  },
];
...
export function applySkin(colors: SkinColors, mode: SkinMode) {
  ...
  // (cardBg < surfaceRaised < surfaceOverlay < border), never computed.
  ...
  s.setProperty("--sidebar", colors.background);
  ...
  s.setProperty("--sidebar-accent", colors.surfaceOverlay);
