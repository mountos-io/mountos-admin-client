<script lang="ts" module>
  ...
  export const badgeVariants = tv({
    base: "focus-visible:border-ring focus-visible:ring-ring/50 inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-sm border px-2 py-0.5 text-xs font-medium transition-[color,box-shadow] focus-visible:ring-[2px] [&>svg]:pointer-events-none [&>svg]:size-3",
    variants: {
      variant: {
        ...
        success: "bg-transparent text-foreground border-foreground/30 [a&]:hover:bg-accent/20",
        warning: "bg-primary/10 text-primary border-primary/30 [a&]:hover:bg-primary/20",
      },
    },
