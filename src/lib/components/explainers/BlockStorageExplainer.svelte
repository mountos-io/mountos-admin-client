...
<div class="space-y-4">
  ...
  <ul class="grid gap-2 text-sm text-muted-foreground sm:grid-cols-2">
    ...
    <li><span class="font-medium text-foreground">Members form a shared copyset pool.</span> Every copyset has exactly two members, registered as a pair directly. Placing them on separate placement or availability zones is advised. A storage's pool holds K copysets, admin-adjustable after creation.</li>
